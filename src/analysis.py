...
- Write for a beginner. Use simple, everyday words.
- No jargon. If you must name something technical (e.g. "yield", "Fed", "OPEC"), add a 2-4 word plain-English meaning in brackets the first time, e.g. "Fed (US central bank)".
- One short sentence per bullet. No sentence should need re-reading.
- Do not over-explain or add background - state the fact and what it means for the investor's money, nothing more.
...
Be factual and to the point. No financial-advice disclaimer needed. Emojis go ONLY at the very start of each section title - never inside a bullet.
